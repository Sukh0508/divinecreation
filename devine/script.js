...
const PRODUCTS = [
  ...
  { id:25, name:"Divine Lord Ganesha – Code P1", cat:"Idol",img:"img/ Lord Ganesha.jpeg", badge:"", badgeLabel:"", stars:"4.7", reviews:"(130)", desc:"Invite auspiciousness and positive energy into your space with the Divine Lord Ganesha Idol (Code P1). Lord Ganesha, the remover of obstacles and the god of wisdom and success, is gracefully depicted with fine detailing and a serene expression that enhances its devotional charm." },
  ...
  { id:41, name:"Divine Aaram Ganesh Idol – Code S6", cat:"Idol",img:"img/divineidolaram.jpeg", badge:"", badgeLabel:"", stars:"4.8", reviews:"(200)", desc:"Bring calmness and divine blessings into your space with the Divine Aaram Ganesh Idol (Code S6). Depicting Lord Ganesha in a relaxed and peaceful posture, this idol represents inner peace, wisdom, and the removal of obstacles. The graceful design and fine detailing enhance its spiritual and aesthetic appeal." },
